  ...
  return (
    <div className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl border border-slate-200/60 overflow-hidden transition-all duration-300 hover:scale-[1.02]">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {/* Discount Badge */}
        {trip.has_discount && (
          <div className="absolute top-4 left-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-3 py-1 rounded-full text-sm font-medium shadow-lg">
            <Icon icon="mdi:percent" className="w-3 h-3 inline mr-1" />
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          <div className="flex items-center space-x-2 bg-slate-100 rounded-lg px-3 py-2 text-sm">
            ...
            <span className="text-slate-700">{trip.duration} days</span>
          </div>
          <div className="flex items-center space-x-2 bg-slate-100 rounded-lg px-3 py-2 text-sm">
            ...
            {trip.images && trip.images.length > 1 && (
              <div className="bg-purple-50 rounded-xl p-4">
                <h4 className="text-sm font-semibold text-purple-800 mb-3 flex items-center">
                  ...
                  Gallery ({trip.images.length} photos)
                </h4>
