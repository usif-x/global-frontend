...
export const metadata = {
  ...
  description:
    "Explore the Red Sea's Beauty with TopDivers, Hurghada Trips,. Red Sea diving, snorkeling, boat & island tours, safari adventures, and Egypt travel packages for all travelers.",
  keywords:
  ...
  twitter: {
    ...
    description:
      "Explore the Red Sea's Beauty with TopDivers, Hurghada Trips,. Red Sea diving, snorkeling, boat & island tours, safari adventures, and Egypt travel packages for all travelers.",
    images: ["https://topdivers.online/image/hero-bg.jpg"],
  },
};
